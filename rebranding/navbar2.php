<nav class="p-3 flex justify-between bg-gray-800">
  <div class="justify-center items-center">
    <a href="index2.php" class="text-cyan-400">
      <h1 class="text-2xl font-bold">NEDLIX</h1>
    </a>
  </div>
  <div class="flex gap-x-4 items-center">
    <a href="index2.php" class="text-white hover:text-cyan-400">All Movies</a>
    ...
    <a href="login2.php" class="text-white hover:text-cyan-400">Login</a>
  </div>
</nav>